...
def _normalize_print_interval_minutes(value: Any, enabled: bool) -> Any:
    if not enabled:
        return None
    if value is None or value == "":
        return None
...
def get_system_settings() -> Dict[str, Any]:
    ...
    settings["printIntervalMinutes"] = _normalize_print_interval_minutes(
        settings.get("printIntervalMinutes"), print_enabled
    )
...
def save_system_settings(settings: Dict[str, Any]) -> Dict[str, Any]:
    ...
    merged["printIntervalMinutes"] = _normalize_print_interval_minutes(
        merged.get("printIntervalMinutes"), print_enabled
    )
